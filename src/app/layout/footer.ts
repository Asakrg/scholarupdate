      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative z-10">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div class="col-span-2 lg:col-span-1 space-y-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <a href="mailto:admin@ecopulse.app" class="w-8 h-8 flex items-center justify-center rounded-lg frost-light text-slate-400 hover:text-white hover:border-indigo-500/30 transition-all">
          ...
          <div class="space-y-4">
            ...
            <div class="flex flex-col gap-2 text-xs text-slate-400">
              ...
              <a routerLink="/resources" class="hover:text-white transition-colors">Blog & Resources</a>
              <a routerLink="/contact" class="hover:text-white transition-colors">Contact Us</a>
              <a href="mailto:admin@ecopulse.app" class="hover:text-white transition-colors">Support Email</a>
            </div>
          </div>
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-4 text-[10px] font-mono text-slate-600">
            <a routerLink="/privacy" class="hover:text-slate-400 transition-colors">Privacy Policy</a>
            <span>•</span>
